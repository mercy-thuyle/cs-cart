<div class="ty-sort-dropdown">
    <a id="sw_elm_sort_fields" class="ty-sort-dropdown__wrapper cm-combination">{__("sort_by_`$search.sort_by`_`$search.sort_order`")}{include_ext file="common/icon.tpl" class="ty-icon-down-micro ty-sort-dropdown__icon"}</a>
