<div class="select-vendor">
    ...
    <div id="{$id}_wrap_" class="ty-select-block cm-popup-box cm-smart-position hidden">
        <input type="text" value="{__("storefront_search_field")}..." class="ty-select-block__input cm-hint cm-ajax-content-input" data-ca-target-id="content_loader_{$id}" size="16" />
        <div id="scroller_{$id}">
