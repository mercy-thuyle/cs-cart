...
<div class="ty-rma-search__buttons buttons-container">
    ...
    {/if}
    {include file="buttons/button.tpl" but_text=__("storefront_search_button") but_name="dispatch[`$runtime.controller`.`$runtime.mode`.`$runtime.action`]" but_meta="ty-btn__secondary"}
</div>
</form>
