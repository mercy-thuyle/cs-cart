            ...
            <td style="background-color: #ffffff; border: 1px solid #e6e6e6; margin: 0px auto; padding: 0px 40px 40px 40px; width: 510px;" align="left">
                ...
                <tr valign="top">
                    <td style="width: 50%; padding: 14px 0px 0px 2px;">
                        ...
                        <tr>
                            ...
                            <td width="100%"><span dir="ltr">{$company_data.company_phone}</span></td>
                        </tr>
                        {/if}
                        ...
                        <tr>
                            ...
                            <td width="100%"><span dir="ltr">{$company_data.company_phone_2}</span></td>
                        </tr>
                        {/if}
                ...
                <tr valign="top">
                    ...
                    <td width="33%">
                        ...
                        <p style="margin: 2px 0px 3px 0px;"><span style="text-transform: uppercase;">{__("phone")}:</span>&nbsp;<span dir="ltr">{$order_info.phone}</span></p>
