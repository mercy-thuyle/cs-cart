                                    ...
                                    <td width="340px" valign="top">
                                        <div style="padding: 15px 0px 0px 18px; color: #ffffff">
                                            ...
                                            <p style="color: #ffffff; padding: 5px 0px 10px 0px; margin: 0px; border-bottom: 1px dashed #72c0f5;">
                                                ...
                                                {if $gift_cert_data.phone}<span dir="ltr">{$gift_cert_data.phone}</span><br />{/if}
                                        ...
                                        <div style="margin: 12px 0px 0px 10px;">
                                            ...
                                            <table border="0" cellpadding="10" cellspacing="10">
                                                ...
                                                {foreach from=$gift_cert_data.products item="product"}
                                                    <tr valign="top">
                                                        <td><span style="color: #ffffff; line-height: 20px; font-weight: bold">{$product.amount}</span>&nbsp;</td><td><a href="{"products.view?product_id=`$product.product_id``$suffix`"|fn_url:'C':'http'}" class="product-link" style="color: #ffffff; line-height: 20px;"><span dir="ltr">{$product.product}</span></a><br />
