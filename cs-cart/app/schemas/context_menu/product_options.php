...
$schema = [
    ...
    'items'               => [
        ...
        'actions'          => [
            ...
            'items'    => [
                'apply_to_products' => [
                    'name'     => ['template' => 'apply_to_products'],
                    'dispatch' => 'product_options.apply',
                    'data'     => [
                        'action_attributes' => [
                            'class' => 'cm-submit cm-apply-product-options-menu-item',
                        ],
                    ],
                    'position' => 10,
                ],
                'delete_selected'   => [
                    ...
                    'dispatch' => 'product_options.m_delete',
                    'data'     => [
...
foreach ($selectable_statuses as $status => $status_name) {
    $item = [
        ...
        'dispatch' => 'product_options.m_update_statuses',
        'data'     => [
            'action_attributes' => [
                'class'               => 'cm-ajax cm-post cm-ajax-send-form',
                'href'                => fn_url('product_options.m_update_statuses?status=' . $status),
