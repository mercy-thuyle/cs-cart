INSERT INTO ?:product_reviews (product_review_id, product_id, user_id, name, advantages, disadvantages, comment, rating_value, ip_address, is_buyer, product_review_timestamp, country_code, city, reply_user_id, reply, reply_timestamp, helpfulness, status, storefront_id, images_count, vote_up, vote_down) VALUES
    ...
    (48, 282, 0, '', '', '', 'I\'m not satisfied with the quality!', 2, '7f000001', 'N', 1618485542, '', '', 1, 'We are sorry to hear that! Could you tell us more? Just send us a message at sales@example.com, and we\'ll see what we can do about it.', 1618485673, 0, 'A', 1, 0, 0, 0),
