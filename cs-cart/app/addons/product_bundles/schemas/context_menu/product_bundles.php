        ...
        'actions' => [
            ...
            'items'    => [
                'delete_selected'   => [
                    ...
                    'dispatch' => 'product_bundles.m_delete',
                    'data'     => [
...
foreach ($selectable_statuses as $status => $status_name) {
    $item = [
        ...
        'dispatch' => 'product_bundles.m_update_statuses',
        'data'     => [
            'action_attributes' => [
                'class'               => 'cm-ajax cm-post cm-ajax-send-form',
                'href'                => fn_url('product_bundles.m_update_statuses?status=' . $status),
                'data-ca-target-id'   => 'manage_product_bundles_form',
                'data-ca-target-form' => '#manage_product_bundles_form',
            ],
        ],
        'position' => $position,
    ];
