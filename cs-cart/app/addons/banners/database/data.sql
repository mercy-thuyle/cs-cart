...
REPLACE INTO ?:banners (banner_id, status, type, target, timestamp) VALUES(16, 'A', 'G', 'T', UNIX_TIMESTAMP(NOW()));
REPLACE INTO ?:banners (banner_id, status, type, target, timestamp) VALUES(17, 'A', 'G', 'T', UNIX_TIMESTAMP(NOW()));
REPLACE INTO ?:banners (banner_id, status, type, target, timestamp) VALUES(18, 'A', 'G', 'T', UNIX_TIMESTAMP(NOW()));
REPLACE INTO ?:banners (banner_id, status, type, target, timestamp) VALUES(19, 'A', 'G', 'T', UNIX_TIMESTAMP(NOW()));
REPLACE INTO ?:banners (banner_id, status, type, target, timestamp) VALUES(6, 'A', 'G', 'T', UNIX_TIMESTAMP(NOW()) - 1000);
REPLACE INTO ?:banners (banner_id, status, type, target, timestamp) VALUES(9, 'A', 'G', 'T', UNIX_TIMESTAMP(NOW()) - 1000);
REPLACE INTO ?:banners (banner_id, status, type, target, timestamp) VALUES(20, 'A', 'G', 'T', UNIX_TIMESTAMP(NOW()) - 1000);
REPLACE INTO ?:banners (banner_id, status, type, target, timestamp) VALUES(21, 'A', 'G', 'T', UNIX_TIMESTAMP(NOW()) - 1000);
REPLACE INTO ?:banners (banner_id, status, type, target, timestamp) VALUES(22, 'A', 'G', 'T', UNIX_TIMESTAMP(NOW()) - 1000);
...
REPLACE INTO ?:images (`image_id`, `image_path`, `image_x`, `image_y`) VALUES(8633, 'banner_acme_mobile.jpg', 770, 471);
REPLACE INTO ?:images (`image_id`, `image_path`, `image_x`, `image_y`) VALUES(8634, 'banner_multivendor_mobile.jpg', 770, 471);
REPLACE INTO ?:images (`image_id`, `image_path`, `image_x`, `image_y`) VALUES(8632, 'banner_x-box_mobile.jpg', 770, 471);
