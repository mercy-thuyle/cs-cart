        ...
        <td style="background-color: #ffffff; border: 1px solid #e6e6e6; margin: 0px auto 0px auto; padding: 0px 44px 0px 46px; text-align: left;">
            ...
            <tr valign="top">
                ...
                <td style="width: 50%; padding: 14px 0px 0px 2px; font-size: 12px; font-family: Arial;">
                    ...
                    <tr valign="top">
                        ...
                        <td width="100%" style="font-size: 12px; font-family: Arial;"><span dir="ltr">{$company_data.company_phone}</span></td>
                    </tr>
                    {/if}
                    ...
                    <tr valign="top">
                        ...
                        <td width="100%" style="font-size: 12px; font-family: Arial;"><span dir="ltr">{$company_data.company_phone_2}</span></td>
                    </tr>
                    {/if}
            ...
            <tr valign="top">
                ...
                <td width="33%" style="font-size: 12px; font-family: Arial;">
                    ...
                    {if $profields_c.phone}<p style="margin: 2px 0px 3px 0px;"><span style="text-transform: uppercase;">{__("phone")}:</span>&nbsp;<span dir="ltr">{$order_info.phone}</span></p>{/if}
                ...
                <td width="34%" style="font-size: 12px; font-family: Arial; {if $profile_fields.S}padding-right: 10px;{/if} {if $profile_fields.C}padding-left: 10px;{/if}">
                    ...
                    <p style="margin: 2px 0px 3px 0px;">
                        {if $profields_b.b_phone}<span dir="ltr">{$order_info.b_phone}</span> {/if}
                    </p>
                    {/if}
                ...
                <td width="33%" style="font-size: 12px; font-family: Arial;">
                    ...
                    <p style="margin: 2px 0px 3px 0px;">
                        {if $profields_s.s_phone}<span dir="ltr">{$order_info.s_phone}</span> {/if}
                    </p>
                    {/if}
