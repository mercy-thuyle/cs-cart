...
{if $e_account == 'updated'}
    {__("text_company_status_new_to_active_administrator_updated", ["[link]" => $vendor_url, "[link_text]" => $vendor_url|puny_decode, "[login]" => $e_username]) nofilter}
{elseif $e_account == 'new'}
    {__("text_company_status_new_to_active_administrator_created", ["[link]" => $vendor_url, "[link_text]" => $vendor_url|puny_decode, "[login]" => $e_username, "[password]" => $e_password]) nofilter}
{/if}
