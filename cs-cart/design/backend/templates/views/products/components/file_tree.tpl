...
<tr class="multiple-table-row cm-row-status-{$product_file.status|lower} ">
    ...
    <td width="15%">
        <div class="pull-right nowrap">
            ...
            {include file="common/select_popup.tpl" id=$id popup_additional_class="dropleft" status=$product_file.status hidden=$hidden object_id_name="file_id" table="product_files" hide_for_vendor=$hide_for_vendor display=$display non_editable=$non_editable}
        </div></td>
</tr>