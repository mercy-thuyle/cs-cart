...
<p>{__("text_pay4later_notice", ["[verified_url]" => $verified_url, "[decline_url]" => $decline_url, "[cancel_url]" => $cancel_url, "[refer_url]" => $refer_url, "[process_url]" => $process_url]) nofilter}</p>
<hr>
