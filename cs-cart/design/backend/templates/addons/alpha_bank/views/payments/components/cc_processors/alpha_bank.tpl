<div class="control-group">
	<label class="control-label" for="ab_merchant_id">{__("alpha_bank.merchant_id")}:</label>
	<div class="controls">
...
<div class="control-group">
    <label class="control-label" for="ab_shared_secret">{__("alpha_bank.shared_secret")}:</label>
    <div class="controls">
