...
<div class="group form-horizontal">
    <div class="control-group">
        <label class="control-label" for="elm_search_language">{__("language")}:</label>
        <div class="controls">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            {include file="common/period_selector.tpl"
                ...
                form_name="subscribers_search_form"
            }
        </div>
    </div>
</div>
...
{include file="common/advanced_search.tpl" simple_search=$smarty.capture.simple_search advanced_search=$smarty.capture.advanced_search dispatch=$dispatch view_type="subscribers"}
